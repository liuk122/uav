...
class CloudUploaderNode(Node):
    def __init__(self):
        ...
        # --- 阿里云 OSS 配置 ---
        self.OSS_ACCESS_KEY_ID = 'LTAI5t8dcF5LZw8WoQfpxuFv'
        self.OSS_ACCESS_KEY_SECRET = 'ZfU5wLPp2qc44yZyAAUPlZF0GdhbZX'
        self.OSS_ENDPOINT = 'oss-cn-beijing.aliyuncs.com'
        self.OSS_BUCKET_NAME = 'lksw'
        self.OSS_VIDEO_FOLDER = 'videos/'
        self.OSS_POSITION_FOLDER = 'position/'
